#!/usr/bin/env python3
"""
lead-generation-api - CoreClaw CoreClaw API Demo
...
def main():
    parser = argparse.ArgumentParser(description="lead-generation-api - CoreClaw CoreClaw API Demo")
    ...
    client = LeadGenerationApi(api_key=args.api_key)
